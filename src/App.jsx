  ...
  return (
    <div style={{minHeight:"100vh",background:C.bg,fontFamily:"'Inter',system-ui,sans-serif",color:C.text,display:"flex",flexDirection:"column"}}>
      ...
      <div style={{flex:1,overflowY:"auto",paddingBottom:80}}>
        ...
        {tab==="account"&&<div style={{padding:14}}><div style={{fontSize:13,color:C.text}}>👤 Account</div><div style={{marginTop:20}}><div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:12,padding:"14px 16px"}}><div style={{fontSize:11,color:C.muted,marginBottom:4}}>Logged in as</div><div style={{fontSize:13,fontWeight:700}}>{user.name}</div><div style={{fontSize:12,color:C.muted,marginTop:4}}>{user.email}</div></div></div></div>}
      </div>
